...
namespace EasyCSIT.Controllers.Semester
{
    public class EightController : Controller
    {
        ...
        public EightController(EasyCSITDB _context)
        {
            context = _context;
        }
        ...
        {
            List<StudentModel> students = context.Students.Where(student => student.Semester == "Eight").Select(student => new StudentModel()
            {
        ...
        public IActionResult Add_Markslip()
        {
            ...
            var Students = context.Students.Where(subject => subject.Semester == "Eight").Select(student => new StudentModel()
            {
                StudentId = student.StudentId,
                StudentName = student.StudentName,
                Address = student.Address,
            ...
            var Subject = context.Subject.Where(subject => subject.Semester == "Eight").Select(subject => new SubjectModel()
            {
