...
namespace EasyCSIT.Controllers.Semester
{
    public class ThirdController : Controller
    {
        ...
        public ThirdController(EasyCSITDB _context)
        {
            context = _context;
        }
        ...
        {
            List<StudentModel> students = context.Students.Where(student => student.Semester == "Third").Select(student => new StudentModel()
            {
        ...
        public IActionResult Add_Markslip()
        {
            ...
            var Students = context.Students.Where(subject => subject.Semester == "Third").Select(student => new StudentModel()
            {
                StudentId = student.StudentId,
                StudentName = student.StudentName,
                Address = student.Address,
            ...
            var Subject = context.Subject.Where(subject => subject.Semester == "Third").Select(subject => new SubjectModel()
            {
