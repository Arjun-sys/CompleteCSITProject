...
namespace EasyCSIT.Controllers.Semester
{
    public class SecondController : Controller
    {
        ...
        public SecondController(EasyCSITDB _context)
        {
            context = _context;
        }
        ...
        {
            List<StudentModel> students = context.Students.Where(student => student.Semester =="Second").Select(student => new StudentModel()
            {
        ...
        public IActionResult Add_Markslip()
        {
            ...
            var Students = context.Students.Where(subject => subject.Semester == "Second").Select(student => new StudentModel()
            {
                StudentId = student.StudentId,
                StudentName = student.StudentName,
                Address = student.Address,
            ...
            var Subject = context.Subject.Where(subject => subject.Semester == "Second").Select(subject => new SubjectModel()
            {
        ...
        public IActionResult Add_Markslip(MarkModel mark)
        {
            ...
            context.Add(markRow);
            context.SaveChanges();
            return RedirectToAction("Add_Markslip");
        }
