...
namespace EasyCSIT.Controllers.Semester
{
    public class SixthController : Controller
    {
        ...
        public SixthController(EasyCSITDB _context)
        {
            context = _context;
        }
        ...
        {
            List<StudentModel> students = context.Students.Where(student => student.Semester == "Sixth").Select(student => new StudentModel()
            {
        ...
        public IActionResult Add_Markslip()
        {
            ...
            var Students = context.Students.Where(subject => subject.Semester == "Sixth").Select(student => new StudentModel()
            {
                StudentId = student.StudentId,
                StudentName = student.StudentName,
                Address = student.Address,
            ...
            var Subject = context.Subject.Where(subject =>subject.Semester == "Sixth").Select(subject => new SubjectModel()
            {
